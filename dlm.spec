...
Version  : 4.1.1
Release  : 5
URL      : https://pagure.io/dlm/archive/dlm-4.1.1/dlm-dlm-4.1.1.tar.gz
Source0  : https://pagure.io/dlm/archive/dlm-4.1.1/dlm-dlm-4.1.1.tar.gz
...
%prep
%setup -q -n dlm-dlm-4.1.1
cd %{_builddir}/dlm-dlm-4.1.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1663617801
...
cp %{_builddir}/dlm-dlm-%{version}/README.license %{buildroot}/usr/share/package-licenses/dlm/2303030c0e7e6704043065164610e93cfb922139
%make_install
